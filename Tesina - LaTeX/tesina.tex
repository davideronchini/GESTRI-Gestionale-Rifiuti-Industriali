...
\begin{figure}[H]
    \vspace{0.5cm}
    \centering
    \includegraphics[width=\textwidth]{CodiceCER.jpg}
...
Attività & Operazione di carico o scarico di rifiuti, con assegnazione di operatori, mezzi e documenti di tipo FIR. & BUSINESS & - \\
Mezzo & Veicolo utilizzato per il trasporto dei rifiuti. & BUSINESS & Veicolo \\
...
\newsubsubsection*{RNF5: Visualizzazione Attivita con Calendario}
...
\end{enumerate} \\ \hline
	\textbf{Postcondizioni} & Nessuna \\ \hline
	\textbf{Sequenza degli eventi alternativa} & \begin{enumerate}[leftmargin=14pt,label=\arabic*.,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
    \item \texttt{If} Il Cliente o l'Operatore inseriscono i criteri di ricerca nella barra dedicata
    \begin{enumerate}[label=\arabic{enumi}.\arabic*.,leftmargin=22pt,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
       \item \texttt{If} l’attività esiste
    \begin{enumerate}[label=\arabic{enumi}.\arabic*.,leftmargin=22pt,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
        \item \texttt{For Each} attività trovata
        \begin{enumerate}[label=\arabic{enumi}.\arabic{enumii}.\arabic*.,leftmargin=22pt,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
            \item Il sistema mostra i risultati dell'attività da lui creata, o a lui associata
        \end{enumerate}
    \end{enumerate}
    \item \texttt{Else}
    \begin{enumerate}[label=\arabic{enumi}.\arabic*.,leftmargin=22pt,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth,trim=0 0 0 728pt,clip]{DiagrammaSequenzaCRUDAttivita}
\end{figure}
...
Nelle pagine successive, per ogni schermata mockup, è mostrata la versione implementata dell’interfaccia. Questo confronto consente di evidenziare come il design ideato sia stato tradotto nell’applicativo finale, garantendo coerenza tra progetto e implementazione.
...
\begin{figure*}[ht!]
    \vspace*{0cm}
    \includegraphics[width=1\textwidth]{MockupHome.png}
    \caption{Mockup Home}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=1\textwidth]{MockupProfilo.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=1\textwidth]{MockupAttività.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=1\textwidth]{MockupMezzo.png}
