...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{DiagrammaPackage}
\end{figure*}
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{DiagrammaClassiUtente}
\end{figure*}
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{DiagrammaClassiMezzo}
\end{figure*}
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{DiagrammaClassiAttivita}
\end{figure*}
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{DiagrammaClassiDocumento}
\end{figure*}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth,trim=0 775pt 0 0,clip]{DiagrammaSequenzaCRUDAttivita}
\end{figure}
\clearpage
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth,trim=0 0 0 735pt,clip]{DiagrammaSequenzaCRUDAttivita}
\end{figure}

\clearpage
\newsubsection{Filtra Documento}
\noindent
Il diagramma di sequenza rappresenta il processo di ricerca avanzata dei documenti, mostrando come l’utente possa applicare criteri di filtro per restringere i risultati. È inoltre considerata l’estensione al caso di ricerca semplice, evidenziando la capacità del sistema di gestire sia query specifiche che generiche.
