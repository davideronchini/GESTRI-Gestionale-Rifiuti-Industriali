...
\newsubsection*{Area: Gestione Utenti}
...
\newsubsubsection*{RF7: Assegnazione Turno}

Il sistema dovrà permettere la creazione e l’assegnazione di turni agli operatori e la loro visualizzazione.

\newsubsubsection*{RF8: Amministrazione Assenze}
...
\newsubsubsection*{RF13: CRUD Scadenza}
...
\newsubsubsection*{RF14: Notifica Scadenza Documento}
...
\newsubsubsection*{RF17: CRUD Mezzo}
...
\newsubsubsection*{RF18: Filtra Mezzo}
...
\textbf{Sequenza degli eventi principale} & \begin{enumerate}[leftmargin=14pt,label=\arabic*.,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
    ...
    (punto di estensione: RecuperaCredenziali)
    ...
    \begin{enumerate}[label=\arabic{enumi}.\arabic*.,leftmargin=22pt,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
        ...
        \item \textbf{If} le credenziali sono valide
        \begin{enumerate}[label=\arabic{enumi}.\arabic*.,leftmargin=30pt,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
            \item Il sistema autentica l’Utente e lo reindirizza alla pagina principale/area riservata
        \end{enumerate}
        \item \textbf{Else}
        \begin{enumerate}[label=\arabic{enumi}.\arabic*.,leftmargin=30pt,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
            \item Il sistema notifica all’Utente che le credenziali sono errate
        \end{enumerate}
    \end{enumerate}
\end{enumerate}\\ \hline
...
\begin{enumerate}[leftmargin=14pt,label=\arabic*.,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
    ...
    \end{enumerate}
    \item \textbf{If} l’email è registrata
    \begin{enumerate}[label=\arabic{enumi}.\arabic*.,leftmargin=22pt,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
    ...
    \item \textbf{Else}
    \begin{enumerate}[label=\arabic{enumi}.\arabic*,leftmargin=22pt,labelsep=0.5em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
        \item Il sistema notifica all’Utente che l’email non è registrata
    \end{enumerate}
